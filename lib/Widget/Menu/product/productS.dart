...
late  List<dynamic> data2 = [];
 bool loading = true;
  Future<void> show_Detailproduct() async {
    try {
      setState(() {
        print(widget.id_product.toString());
        loading = true;
      });
  ...
  // วนลูปเพื่อดึงชื่อ type และเพิ่มเข้า List ถ้ายังไม่มีใน List อยู่
    ...
    print('typeList==>$typeName');
    if (!typeList.contains(typeName)) {
      typeList.add(typeName);
    }
  }
  print('typeList==>${widget.id_product.toString()}');
       ...
       data2.add(data[i]);
                                        ...
                                        for(var i = 0;i<data.length;i++){
                                           if(data[i]['type'].toString()== typeListname){
                                             print(data[i]);
                                              datas = data[i];
                                              if('${datas!['size_name']}' == 'freesize'){
                                              Sum = int.parse('${datas!["amount"]}') >= 1  ? 1: int.parse('${datas!["amount"]}') < 0 ? 0: int.parse('${datas!['amount']}');
                                              }else{
...
if(int.parse('${datas!['amount']}')<=0 || '${datas!['amount']}' == 'null'){
                                                 Sum =  Sum +1;
                                                     ...
                                                     if(int.parse('${datas!['amount']}') < Sum +1){
                                    ...
                                    Container(
                                      ...
                                      : int.parse('${datas!["amount"]}') >= 100 ?Text(
                                        '',
                                        textScaleFactor: 1.0,
                                        style: TextStyle(
                                          // fontFamily: 'IBM',
                         ...
                         typeList.length == 1? Container() : Container(
                       ...
                       Expanded(
                         child: Container(
                             ...
                             child: 
                              ...
                              typeList.length == 1? Container() :ListView.builder(
                                scrollDirection: Axis.horizontal,
                                shrinkWrap: true,
                    ...
                    child: Image.asset(
                     ...
                     data2.length == 1? Container()
                      ...
                      : Padding(padding: EdgeInsets.only(),
                           ...
                           '${datas!['detail_product']}' == 'null' ? Text(''):  Container(
                            
                                         child:  HtmlWidget(
                                                '''${datas!['detail_product']}''',
                                                // textScaleFactor: 1.0,
                                                // style: TextStyle(
                                                //   // fontFamily: 'IBM',
                                                //   fontSize: 13,
                                          ...
                                          Container(
                                            height: 50,
                                                                                   ...
                                                                                   child:   '${datas!['size_name']}' != 'freesize'?Container()
                                                                                    : Container(
                                                                                      child: Row(
                                                                                        children: [
                                                                                          Text(
                                                                                          ...
                                                                                          Container(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                               ...
                                                                                               child: Image.asset(
                                                                                                 'assets/images/iconfinder_line_3069725 (1) 1.png',
  ...
  Future<void> cart(var id_product_amount,var amount) async {
    ...
    void _openLineChat(var LINE_ID) async {
    var url = 'line://ti/p/~$LINE_ID'; // แทน YOUR_LINE_ID ด้วย ID ของ LINE ของคุณ
