...
class EDIT_address extends StatefulWidget {
  Map<String,dynamic>? date;
   EDIT_address({super.key,this.date});
...
class _EDIT_addressState extends State<EDIT_address> {
    ...
    try {
      ...
      if(ressum.statusCode == 200){
        ...
        "deleted_at": null
         ...
         if(widget.date!['province'].toString() == 'null'){
            
                _province.text = citys![0]['id'];
              //  get_amupurs(_province.text);
         }else{
           for(var i = 0; i<citys!.length;i++){
             if(extractProviderNumber(widget.date!['province'].toString()) == extractProviderNumber(citys![i]['name_th'].toString())){
    ...
    try {
     ...
     print('5555555 $city');
      ...
      if(ressum.statusCode == 200){
       ...
       if(widget.date!['district'].toString() == 'null'){
           ...
           for(var i = 0; i<get_amupurss!.length;i++){
             ...
             if(extractDisNumber(widget.date!['district'].toString()) == extractDisNumber(get_amupurss![i]['name_th'].toString())){
    ...
    try {
     print('5555555 $ampurs');
      ...
      if(ressum.statusCode == 200){
       ...
       if(widget.date!['subdistrict'].toString() == 'null'){
           ...
           for(var i = 0; i<get_tambonss!.length;i++){
             if(extractSubDisNumber(widget.date!['subdistrict'].toString()) == extractSubDisNumber(get_tambonss![i]['name_th'].toString())){
  ...
  void initState() {
    ...
    super.initState();
    _name.text = widget.date!['name'].toString();
     _phone.text = widget.date!['phone'].toString();
      _address.text = widget.date!['address'].toString();
       _streetAddress.text = widget.date!['streetAddress'].toString();
       _postcode.text = widget.date!['postcode'].toString();
        _province2.text = widget.date!['province'].toString();
        _district2.text = widget.date!['district'].toString();
        _subdistrict2.text = widget.date!['subdistrict'].toString();
      if(widget.date!['status'].toString() == 'inactive'){
        _switchVal = false;
      }else{
        _switchVal = true;
      }
